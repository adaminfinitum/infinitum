...
add_action( 'tgmpa_register', 'ai_register_required_plugins' );
 ...
 */
function ai_add_post_type_caps() {
	// ai_add_capabilities( 'portfolio' );
}

/**
 * Filter Yoast SEO Metabox Priority
 */
add_filter( 'wpseo_metabox_prio', 'ai_filter_yoast_seo_metabox' );
function ai_filter_yoast_seo_metabox() {
	return 'low';
}
