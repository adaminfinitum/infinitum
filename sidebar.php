<aside class="four columns">
   <div class="clearfix">
        ...
        <script>function googleTranslateElementInit() {new google.translate.TranslateElement({pageLanguage: 'en', gaTrack: true, gaId: 'UA-27155590-1'}, 'google_translate_element');}</script>
